...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="about-us-info-wrap">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipis icing elit, sed do eius mod tempor incididunt ut
                            labore et dolore magna aliqua. Ut enim ad min im veniam, quis nostrud exercitation ullamco
                            laboris nisi ut aliquip ex ea commodo consequ at. </p>
    ...
    <div class="call-to-action-area call-to-action-5 bg-image bg-overlay-theme-90 pt-40 pb-25" data-bg="assets/img/bg/13.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
